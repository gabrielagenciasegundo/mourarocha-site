  ...
  return (
    <section id="equipe" className="bg-white px-6 py-24 md:py-36">
      <div className="mx-auto max-w-[1400px] space-y-16">
        ...
        {/* Partner Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto lg:max-w-none lg:mx-0">
          {partners.map((partner, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden bg-slate-50 rounded-2xl border border-slate-200 hover:border-[#243588]/40 hover:shadow-xl transition-all duration-500"
            >
              {/* Photo */}
              <div className="relative overflow-hidden h-80">
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(to top, rgba(36,53,136,0.6) 0%, transparent 60%)" }}
                ></div>
              </div>
              ...
              <div className="p-7 space-y-3">
                <div>
                  ...
                  <p className="text-sm font-semibold" style={{ color: "#243588" }}>
                    {partner.role}
                  </p>
                </div>
                <p className="text-sm text-slate-500 leading-relaxed">{partner.specialty}</p>
                ...
                <div className="flex items-center gap-3 pt-2">
                  <a
                    ...
                    className="flex items-center justify-center w-9 h-9 rounded-lg border border-slate-200 text-slate-500 hover:bg-[#243588] hover:text-white hover:border-[#243588] transition-all duration-300"
                    aria-label="LinkedIn"
                  >
